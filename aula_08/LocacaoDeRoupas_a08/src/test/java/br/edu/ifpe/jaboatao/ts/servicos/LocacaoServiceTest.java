...
import br.edu.ifpe.jaboatao.ts.builders.ClienteBuilder;
...
//		
//		//Verifica��o
//		Assertions.assertEquals(142.5, locacao.getValorLocacao());
//	}
	@Test
...
//		Cliente cliente = new Cliente("Ana");
	...
	@Test
	@DisplayName("Desconto de 25% na 3º peça de roupa.")
	public void desconto01() throws FilmesExceptions {
		//Cenário
		Cliente cliente = ClienteBuilder.umCliente().agora();
		List<Roupa> roupas = 
				Arrays.asList(
						RoupaBuilder.umaRoupa().comValor(100).agora(),		//100.0
						RoupaBuilder.umaRoupa().comValor(100).agora(),	//100.0
						RoupaBuilder.umaRoupa().comValor(100).agora());	//75.0
		//Ação
		Locacao locacao = service.alugarRoupa(cliente, roupas);
		
		//Verificação
		Assertions.assertEquals(275.0, locacao.getValorLocacao());
	}
	
	@Test
	@DisplayName("Desconto de 50% na 4º peça de roupa.")
	public void desconto02() throws FilmesExceptions {
		//Cenário
		Cliente cliente = ClienteBuilder.umCliente().agora();
		List<Roupa> roupas = 
				Arrays.asList(
						...
						RoupaBuilder.umaRoupa().comValor(100).agora(),	//100.0
						RoupaBuilder.umaRoupa().comValor(100).agora(),  //75.0
						RoupaBuilder.umaRoupa().comValor(100).agora()	//50.0
						);	
		//Ação
		Locacao locacao = service.alugarRoupa(cliente, roupas);
		
		//Verificação
		Assertions.assertEquals(325.0, locacao.getValorLocacao());
	}
	@Test
	@DisplayName("Desconto de 75% na 5º peça de roupa.")
	public void desconto03() throws FilmesExceptions {
		//Cenário
		Cliente cliente = ClienteBuilder.umCliente().agora();
		List<Roupa> roupas = 
				Arrays.asList(
						...
						RoupaBuilder.umaRoupa().comValor(100).agora(),  //75.0$
						RoupaBuilder.umaRoupa().comValor(100).agora(),	//50.0
						RoupaBuilder.umaRoupa().comValor(100).agora()	//25.0
						);	
		//Ação
		Locacao locacao = service.alugarRoupa(cliente, roupas);
		
		//Verificação
		Assertions.assertEquals(350.0, locacao.getValorLocacao());
	}
	@Test
	@DisplayName("Desconto de 100% na 6º peça de roupa.")
	public void desconto04() throws FilmesExceptions {
		//Cenário
		Cliente cliente = ClienteBuilder.umCliente().agora();
		List<Roupa> roupas = 
				Arrays.asList(
						...
						RoupaBuilder.umaRoupa().comValor(100).agora(),	//50.0
						RoupaBuilder.umaRoupa().comValor(100).agora(),	//25.0
						RoupaBuilder.umaRoupa().comValor(100).agora()	//0.0
						);	
		//Ação
		Locacao locacao = service.alugarRoupa(cliente, roupas);
